...
function calcularDistribucion() {
    ...
    palets.forEach(palet => {
        ...
        for (let i = 0; i < cantidad; i++) {
            // Si no cabe horizontalmente, bajar a la siguiente fila
            ...
            if (currentY + ancho <= camionAncho) {
                ...
                currentX += largo; // Avanzar en el eje X
            } else {
                alert(`No hay suficiente espacio para más palets de ${largo}x${ancho}.`);
                break;
            }
        }

        // Sumar metros lineales ocupados
        totalLdm += (cantidad * largo) / 100;
    });
